            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-8">
                ...
                <div className="grid lg:grid-cols-3 gap-10">
                    ...
                    <div className="group bg-white rounded-[14px] overflow-hidden shadow-[0_20px_40px_rgba(1,30,81,0.08)] hover:-translate-y-1.5 hover:shadow-[0_30px_60px_rgba(1,30,81,0.14)] transition-all duration-200 reveal">
                        <div className="relative h-[260px]">
                            <Image
                                ...
                                alt="Aishwaryam Commercial Project"
                                fill
                    ...
                    <div className="group bg-white rounded-[14px] overflow-hidden shadow-[0_20px_40px_rgba(1,30,81,0.08)] hover:-translate-y-1.5 hover:shadow-[0_30px_60px_rgba(1,30,81,0.14)] transition-all duration-200 reveal">
                        <div className="relative h-[260px]">
                            <Image
                                src="/images/projects/krishnapuram/1.png"
                                alt="Krishnapuram Residential Project"
                                fill
                                className="object-cover block"
                                sizes="(max-width: 1024px) 100vw, 33vw"
                            />
                        ...
                        <div className="px-7 pt-[26px] pb-8">
                            ...
                            <p className="text-[#64748B] text-[14px] mb-4">
                                Residential · Bilaspur
                            </p>
                            <Link href="/projects/krishnapuram" className="text-[#011E51] font-medium transition-all duration-150 hover:text-brand-gold hover:translate-x-1 inline-block">
                                View Project →
                            </Link>
                        </div>
                    </div>
