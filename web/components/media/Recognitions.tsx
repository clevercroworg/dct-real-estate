...
import ScrollReveal from '@/app/(main)/components/ScrollReveal';
import Image from 'next/image';

export default function Recognitions() {
    return (
        <div className="space-y-20 py-10">
            {/* SECTION: NITIN GADKARI */}
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        ...
                        <div className="order-2 lg:order-2">
                            <ScrollReveal animationClass="animate-slide-left">
                                <div className="bg-brand-gold text-white inline-block px-6 py-2 rounded-full text-sm font-bold mb-6">
