    ...
    return (
        <div className="min-h-screen bg-[#F9F9F7]">
            ...
            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
                <div className="mb-8">
                    <h2 className="text-2xl font-bold text-[#061B3A] font-heading">Blog Management</h2>
                    <p className="text-slate-500 mt-1">Create, edit, and manage articles on the public website.</p>
                </div>
