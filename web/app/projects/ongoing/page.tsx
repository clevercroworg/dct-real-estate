...
export const metadata = {
    ...
    description: 'Explore ongoing residential, farmhouse, and plotted developments by DCT Real Estate in Bilaspur and nearby locations.',
};
                ...
                <div className="relative z-20 max-w-7xl mx-auto px-6 lg:px-8 pb-16 pt-32 w-full">
                    <div className="max-w-2xl">
                        ...
                        <p className="text-white/80 mt-4 text-base lg:text-lg leading-relaxed">
                            Discover our live developments across Bilaspur and nearby locations—each designed
