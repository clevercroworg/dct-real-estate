        ...
        <div className="min-h-screen bg-white">
            <main className="pt-24">
                ...
                <section className="relative bg-[#061B3A] text-white py-20 overflow-hidden">
                    <div className="absolute inset-0 opacity-20" style={{ backgroundImage: 'linear-gradient(120deg, rgba(201,162,77,0.25), transparent 40%)' }}></div>
                    <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10 text-center">
                        <p className="uppercase text-xs tracking-[0.3em] text-white/60 animate-slide-left">Director Messages</p>
                        <h1 className="font-heading text-4xl md:text-5xl font-bold mt-3 animate-slide-right">
                            Leadership & Vision
                        </h1>
                    </div>
                </section>
                ...
                <section className="py-20 bg-[#F7F3EA] overflow-hidden">
                    <div className="max-w-7xl mx-auto px-6 lg:px-8">
                        <div className="grid lg:grid-cols-2 gap-12 items-center">
                            <div className="order-1 animate-slide-right">
                            ...
                            <div className="order-2 animate-slide-left">
                                <div className="bg-brand-gold text-white inline-block px-6 py-2 rounded-full font-bold mb-6">
